...
<img loading="eager" src={hero} alt="Mockup of scientific software." class="hero"/>  <br  />  <br  />
...
<img loading="lazy" src={sorting} alt="Cell-sorting system." class="center"/>
...
<img loading="lazy" src={working} alt="Srini at work." class="center"/>
...
<img loading="lazy" src={channels} alt="Microscopic channels." class="center"/>
...
<img loading="lazy" src={evangelion} alt="Diagrams in Neon Genesis Evangelion" class="center"/>
...
<img loading="lazy" src={kinesis} alt="Screenshot of Kinesis S" class="center"/>
<div class="caption">Kinesis S (laser controller software) during development.  <br  /> It shows that two links are disconnected.</div>

<img loading="lazy" src={spinner} alt="My spin-coater" class="center"/>
...
<img loading="lazy" src={mcs1} alt="My microfluidic chip" class="center"/>
...
<img loading="lazy" src={channel} alt="A nanoscopic channel" class="center"/>
