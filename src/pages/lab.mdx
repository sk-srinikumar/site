...
import hero from "../images/lab/hero.png"
import lab from "../images/lab/lab.jpeg"
import sorting from "../images/lab/sorting.jpeg"
import working from "../images/lab/working.jpeg"
import evangelion from "../images/lab/evangelion.gif"
import kinesis from "../images/lab/kinesis.jpeg"
import channels from "../images/lab/channels.jpeg"
import channel from "../images/lab/channel.jpeg"
import spinner from "../images/lab/spinner.jpg"
import mcs1 from "../images/lab/mcs1.png"

<SEO title="Microbiology Lab" keywords={['srini', 'kumar', 'designer', 'user', 'experience', 'product', 'interaction', 'gatsby', 'application', 'react']} />

<img src={hero} alt="Mockup of scientific software." class="hero"/>  <br  />  <br  />
...
<img src={lab} alt="Our lab." class="center"/>
<div class="caption">The main room of our lab.</div>

## ENTER SRINI
My duty was to design software tools, hardware equipment, and the entire lab itself. The challenge was to 
improve the UX and efficiency of expensive custom-built bleeding-edge systems used by our scientists at the lab.

Every project had different teams. I worked with engineers, chemists, carpenters, biophysicists, etc.
I was the only designer. 

<img src={sorting} alt="Cell-sorting system." class="center"/>
...
<img src={working} alt="Srini at work." class="center"/>
<div class="caption">Getting my hands dirty.</div>

## TEACH ME 
One of my favorites ways to understand users is to ask them to teach me things. When my users taught me how to work alongside them on their
research, they revealed the inner workings of their minds. Asking neutral questions on how to use tools can easily get them to reveal their pain-points. 

The scientists' understanding of their tools was limited. If I asked them to explain the inner-workings of our cell-sorting system, they'd respond "I don't know".
This was an issue.

## KILLING SPIRITS
You would not believe how often equipment breaks down at the lab. That's the boon of high-tech custom-built tools. 
...
of work and thousands in funding. It's high stakes. I've seen my users bang on keyboards, moan in pain, and look down in despair when
their tools break. How can they fix something they don't understand?

<img src={channels} alt="Microscopic channels." class="center"/>
...
<img src={evangelion} alt="Diagrams in Neon Genesis Evangelion" class="center"/>
...
* Not just how a tool works immediately, but also how it works in the greater system.
...
Most importantly, I had to account for designing each product within a month.

<img src={kinesis} alt="Screenshot of Kinesis S" class="center"/>
<div class="caption">Kinesis S (laser controller software) during development.  <br  /> It shows that two links are disconnected.</div>

<img src={spinner} alt="My spin-coater" class="center"/>
<div class="caption">My spin-coater lays out all details of every phase.  <br  />Typical spin-coaters only show some details at a time.</div>

<img src={mcs1} alt="My microfluidic chip" class="center"/>
...
fixed equipment fast because of my show & tell philosophy. 

Since I was delivering good results, my budget & scope increased with every project.

<img src={channel} alt="A microscopic channel" class="center"/>
<div class="caption">An image of a microscopic channel I designed and made.  <br  />This one is actually deformed...</div>
