...
<img height="293px" loading="lazy" src={mtsm} alt="Mockup of a web app."  class="center"/>
...
<img height="280px" loading="lazy" src={guide} alt="A sketch for my developers."  class="center"/>
